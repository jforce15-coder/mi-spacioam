  ...
  return (
    <div style={{ minHeight: "100dvh", display: "grid", gridTemplateColumns: "1fr", background: "var(--alabaster)" }} className="sa-login">
      ...
      <aside className="sa-login-aside" style={{
        ...
        <img src="assets/brushstroke.svg" aria-hidden="true" style={{ position: "absolute", top: "18%", left: "-20%", width: "150%", opacity: 0.55, pointerEvents: "none", transform: "rotate(-4deg)" }} />
        <div style={{ position: "relative", zIndex: 2 }}><img src="assets/logo-stamp.png" alt="Spacio AM" style={{ height: 64, width: "auto", display: "block" }} /></div>
      ...
      <main style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "40px 24px", position: "relative" }}>
        ...
        <div style={{ width: "100%", maxWidth: 380 }}>
          <div className="sa-login-mark" style={{ display: "flex", justifyContent: "flex-start", marginBottom: 30 }}><img src="assets/logo-wordmark.png" alt="Spacio AM" style={{ height: 72, width: "auto", display: "block" }} /></div>
